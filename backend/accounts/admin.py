...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ("Professional Info", {
            "fields": ("user_type", "department", "employee_id")
        }),
        ("Permissions", {
...
# -------------------------
admin.site.site_header = "Corruption Reporting and Case Tracking System Administration"
admin.site.site_title = "System Admin Portal"

...
const Report = () => {
  ...
  const handleFileUpload = (files) => {
    ...
    const validFiles = fileList.filter((file) => {
      ...
      if (!allowedTypes.includes(file.type)) {
        alert(
          `File ${file.name} type is not supported. Supported types: JPG, PNG, PDF, MP4, DOC, DOCX`,
        );
        return false;
      }
  ...
  const nextStep = async () => {
    ...
    switch (step) {
      ...
      case 3:
        ...
        const partiesValid = involvedParties.every(
          (party) => party.party_type && party.name.trim(),
        );
        if (!partiesValid) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      alert(
        `There was an error submitting your report: ${error.response?.data?.message || error.message}`,
      );
      setIsSubmitting(false);
    }
  };
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Thank you for taking a stand against corruption. Your report has
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
              <h3 className="text-lg font-semibold text-blue-900 mb-2">
                Your Case ID:{" "}
                <span className="font-mono bg-blue-900 text-yellow-400 px-3 py-1 rounded-md">
                  {caseId}
                </span>
              </h3>
              <p className="text-blue-700">
                Please save this ID to track your case progress.
              </p>
            </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Help us fight corruption by providing detailed information about the
            incident. Your report makes a difference.
          </p>
        </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    Provide basic information about the corruption incident.
                  </p>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    Upload any supporting evidence (documents, photos, videos).
                    This step is optional but can strengthen your case.
                  </p>
                </div>
            ...
            {step === 3 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    Add information about the government offices, officials, or
                    individuals involved in the corruption incident.
                  </p>
                </div>
                ...
                {involvedParties.length === 0 && (
                  <div className="text-center py-12 border-2 border-dashed border-gray-300 rounded-2xl">
                    ...
                    <p className="text-gray-500 text-lg">
                      No involved parties added yet. Click the button above to
                      add parties involved in the corruption incident.
                    </p>
                  </div>
                )}
              </div>
            ...
            {step === 4 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    Choose how you want to be identified when reporting this
                    incident.
                  </p>
                </div>
            ...
            {step === 5 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    Please review your report before submitting. You cannot edit
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">
                          {new Date(watch("datetime")).toLocaleString()}
                        </p>
                      </div>
                      <div className="md:col-span-2">
                      ...
                      {!isAnonymous && (
                        <>
                          ...
                          <div>
                            ...
                            <p className="text-gray-900">
                              {watch("reporter_email")}
                            </p>
                          </div>
                          <div>
                            <strong className="text-gray-700">Phone:</strong>
                            <p className="text-gray-900">
                              {watch("reporter_phone")}
                            </p>
                          </div>
                        </>
                      )}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700">
                        By submitting this report, you acknowledge that all
                        information provided will be handled with strict
                        confidentiality and in accordance with data protection
                        laws. Your identity will be protected throughout the
